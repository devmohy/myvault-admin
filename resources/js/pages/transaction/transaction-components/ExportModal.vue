...
function exportTransactionAsCSV() {
    try {
        ...
        api.post("transaction/export", formData, {responseType: 'blob'}).then((response) => {
        ...
        setTimeout(() => { document.getElementById("export-transaction-btn").click();});
    }
}
