...
const formatCurrency = () => {
  const cleanedValue = inputValue.value.replace(/[^0-9.]/g, '');

  if (!isNaN(cleanedValue)) {
    const amount = parseFloat(cleanedValue);
    const formattedAmount = amount % 1 === 0 ? amount.toLocaleString() : amount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
...
watch(inputValue, formatCurrency);
    ...
    <div class="flex mb-6">
      <div class="relative w-full">
        ...
        >
          ...
          >
            <path
              d="M1.232 10V6.402H0.14V5.506H1.232V4.358H0.14V3.462H1.232V0.00399935H2.688L4.018 3.462H5.67V0.00399935H6.776V3.462H7.868V4.358H6.776V5.506H7.868V6.402H6.776V10H5.306L3.976 6.402H2.324V10H1.232ZM2.324 5.506H3.64L3.22 4.358H2.296L2.324 5.506ZM5.67 8.026H5.726L5.684 6.402H5.096L5.67 8.026ZM2.296 3.462H2.884L2.296 1.726H2.24L2.296 3.462ZM4.76 5.506H5.698L5.67 4.358H4.34L4.76 5.506Z"
              fill="#344054"
            />
          </svg>
        </div>
      ...
      :value="modelValue"
      class="block p-[12px] w-full z-20 ps-10 text-sm text-gray-900 rounded-s-lg border-e-gray-50 border-e-2 border border-gray-300"
      @input="updateValue"
      required
    />
      ...
      <button
        ...
        class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 border border-l-0 border-gray-300 rounded-e-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600"
        type="button"
      >
        NGN
        <svg
