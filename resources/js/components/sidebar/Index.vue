...
<template>
  ...
  <aside
    ...
    class="left-0 z-40 md:z-10 h-screen transition-transform -translate-x-full sm:translate-x-0 md:top-auto top-0"
    aria-label="Sidebar"
  >
    <div class="h-full px-3 py-4 overflow-y-auto text-gray-50">
      <div class="max-w-sm">
      ...
      <template v-for="sidebar in filteredSidebars">
        <ul
          ...
          class="pt-4 mt-2 space-y-2 font-medium text-sm border-t border-gray-700"
        >
